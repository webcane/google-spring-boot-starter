...
public class GoogleAutoConfiguration {
	...
	protected static class GoogleConfigurationAdapter extends SocialConfigurerAdapter {
		...
		public void addConnectionFactories(ConnectionFactoryConfigurer configurer, Environment environment) {
			GoogleConnectionFactory googleConnectionFactory = new GoogleConnectionFactory(this.properties.getAppId(), this.properties.getAppSecret());
			// add required scope
			googleConnectionFactory.setScope("https://www.googleapis.com/auth/" + this.properties.getAppScope());
